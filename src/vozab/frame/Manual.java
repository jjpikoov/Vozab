...
public class Manual extends InfoView
{
	static String text = "Vozab is simple swing application to learn foreign languages.\n\n\n"
			...
			+ "If you know the ansewer you can just click on SHOW ANSWER button to check if you are right, "
			+ "If you aren't or you don't rembember, don't worry, next time will be better!\n\n\n"
